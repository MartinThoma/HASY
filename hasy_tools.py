...
def generate_index(csv_filepath):
    ...
    ----------
    csv_filepath : str
        Path to 'hasy-test-labels.csv' or 'hasy-train-labels.csv'
...
def _analyze_class_distribution(csv_filepath='hasy-train-labels.csv',
                                max_data=1000,
                                bin_size=25):
...
def _analyze_pca(csv_filepath='hasy-train-labels.csv'):
    """
...
def _analyze_distances(csv_filepath='hasy-train-labels.csv'):
...
def _analyze_variance(csv_filepath='hasy-train-labels.csv'):
    symbol_id2index = generate_index(csv_filepath)
    data, y = load_images(csv_filepath, symbol_id2index, one_hot=False)
    # Calculate mean
    sum_ = np.zeros((32, 32))
...
def _analyze_correlation(csv_filepath='hasy-train-labels.csv'):
    """
